...
Il reste: 1. les interfaces d'exploration, 2. à améliorer les méthodes pour les rendre pertinentes -> il faut des gens métier. phonogram, rusalka

TODO: ajouter le lien de la prez au début


TODO: Ricardo: prévenir en amont en équipant les chercheurs
TODO: aider les chercheurs à faire les associations Projet Russe

TODO: de meilleures méthodes pour le big data
