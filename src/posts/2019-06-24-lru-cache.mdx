...
2. A way to store our items in the order of their last access. What's more, we will need to be to move items around efficiently. That's why people naturally lean toward a [doubly-linked list](https://en.wikipedia.org/wiki/Doubly_linked_list) for the job.
