...
<p>
  <MarginNote>There are many ways to implement a LRU cache. I only focus on the way you are most likely to encounter in the wild when dealing with high-level languages.</MarginNote>
