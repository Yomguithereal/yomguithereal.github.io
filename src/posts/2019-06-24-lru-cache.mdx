...
And herein lies the issue: we want to avoid fetching the same url more than once and we also want to make sure we won't run out of memory. We have to find a way to compromise.
