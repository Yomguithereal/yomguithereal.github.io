...
To make sure of this, I obviously had to implement th custom pointer system I just described and benchmark it.
...
<p>
  And here are some of the latest results (ran on a 2013 Macbook using node <code>10.13.0</code>):
  <SideNote id="bench">
    Note that I hid results from the <SafeLink href="https://npmjs.com/package/hashlru">hashlru</SafeLink> and <SafeLink href="https://npmjs.com/package/quick-lru">quick-lru</SafeLink> because they are not traditional LRU caches and consume twice the required memory.<br /><br />They still have, mostly the first one, very good write performance but somewhat less good read performance.</SideNote>
    <SideNote id="rank">Libraries are ranked here by eviction performance because this is usually the slowest operation and the most critical for a LRU cache.
  </SideNote>
</p>

| name                                                           | set   | get1  | update | get2  | evict |
|----------------------------------------------------------------|-------|-------|--------|-------|-------|
| [mnemonist-object](https://www.npmjs.com/package/mnemonist)    | 12962 | 57307 | 35026  | 59172 | 6803  |
| [tiny-lru](https://npmjs.com/package/tiny-lru)                 | 5940  | 38685 | 26918  | 37037 | 5016  |
| [lru-fast](https://npmjs.com/package/lru-fast)                 | 5379  | 28860 | 27855  | 29940 | 4099  |
| [mnemonist-map](https://www.npmjs.com/package/mnemonist)       | 4910  | 9857  | 7918   | 9945  | 3510  |
| [lru](https://www.npmjs.com/package/lru)                       | 3619  | 4333  | 4164   | 4400  | 2363  |
| [simple-lru-cache](https://npmjs.com/package/simple-lru-cache) | 2817  | 3779  | 3681   | 3761  | 2210  |
| [hyperlru-object](https://npmjs.com/package/hyperlru-object)   | 2530  | 3930  | 4153   | 4153  | 1820  |
| [js-lru](https://www.npmjs.com/package/js-lru)                 | 2844  | 4415  | 4363   | 5176  | 1643  |
| [secondary-cache](https://npmjs.com/package/secondary-cache)   | 2653  | 4561  | 4557   | 7840  | 1356  |
| [lru-cache](https://npmjs.com/package/lru-cache)               | 1941  | 2520  | 2526   | 2611  | 1294  |
| [hyperlru-map](https://npmjs.com/package/hyperlru-map)         | 1607  | 1948  | 2652   | 2059  | 1271  |
| [modern-lru](https://npmjs.com/package/modern-lru)             | 2132  | 2687  | 2251   | 2744  | 1026  |
| [mkc](https://npmjs.com/packacge/package/mkc)                  | 1447  | 1714  | 1034   | 1750  | 881   |

mnemonist's custom pointer system fares quite well.

What's more, you'll see by reading its [source code](https://github.com/Yomguithereal/mnemonist/blob/master/lru-cache.js) that it's not too horrible to read and remains somewhat simple.
...
Just note that it's usually not a good idea, in JavaScript, if you want to be remain performant (computation-wise, not memory-wise, obviously) because it will incur more hashmap lookups to update pointers, and those are quite costly.
