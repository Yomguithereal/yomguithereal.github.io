...
You can get the full code <a href="{{ site.baseurl }}js/lib/sigma.renderers.nodeBorder.js" target="_blank">here</a> if you need it.
...
<script type="text/javascript" src="{{ site.baseurl }}js/lib/faker.min.js"></script>
<script type="text/javascript" src="{{ site.baseurl }}js/lib/sigma.min.js"></script>
<script type="text/javascript" src="{{ site.baseurl }}js/lib/sigma.forceAtlas2.min.js"></script>
<script type="text/javascript" src="{{ site.baseurl }}js/lib/sigma.graph.dropOrphans.js"></script>
<script type="text/javascript" src="{{ site.baseurl }}js/lib/sigma.renderers.nodeBorder.js"></script>
<script type="text/javascript" src="{{ site.baseurl }}js/lib/sigma.renderers.edgeSilly.js"></script>
<script type="text/javascript" src="{{ site.baseurl }}js/articles/node-border-renderer.js"></script>
